...
public class CustomeSpinnerCategoryAdapter extends BaseAdapter {

    private ArrayList<Categorydetail> _data;
    Context _c;

    CustomeSpinnerCategoryAdapter(ArrayList<Categorydetail> data, Context c){
        _data = data;
        _c = c;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null)
        {
            ...
            v = vi.inflate(R.layout.category_list_row_spiner, null);
        }
