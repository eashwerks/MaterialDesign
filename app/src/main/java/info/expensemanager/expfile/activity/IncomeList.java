       ...
       // getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        ExpensListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
              ...
              //  LinearLayout dialogButton = (LinearLayout) dialog.findViewById(R.id.Linear4);
                //  LinearLayout dialogButton = (LinearLayout) dialog.findViewById(R.id.Linear4);
...
*/
        ...
        if(TYPE.equals("MONTH_REPORT")) {
            ...
            try
            {
                cursor=qc.getAllIncomeMonthly(Monthint, Integer.parseInt(YEAR));
            }
            catch (Exception ex){
          ...
          String  DATE2 = inte.getStringExtra("TODATE");
            if(DATE2.equals("")) {
                try {
                    cursor = qc.getAllIncomeBydate(DATE);
                } catch (Exception ex) {
            ...
            {
                try {
                    cursor = qc.getAllIncomeByTwodate(DATE,DATE2);
                } catch (Exception ex) {
        ...
        try
        {
            ...
            if(length_cursor==0)
            {
                ...
                Intent n=new Intent(getBaseContext(),IncomeReport.class);
                startActivity(n);
                finish();
            }
            else {
